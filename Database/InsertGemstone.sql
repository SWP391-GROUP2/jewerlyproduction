...
VALUES
    ...
    ('GS003', 'Sapphire', 'Blue', 1.8, 'Emerald', 'SI1', 6000.00),
    ('GS004', 'Emerald', 'Green', 3.5, 'Step Cut', 'IF', 10000.00),
    ('GS005', 'Tanzanite', 'Violet-Blue', 2.5, 'Trillion', 'VS1', 4000.00),
    ('GS006', 'Opal', 'Iridescent', 1.2, 'Cabochon', 'N/A', 3000.00),
    ('GS007', 'Pearl', 'White', 3.0, 'Round', 'A', 2000.00),
